...
public class MovieConverter {
    public void convertFramesToMovie(int width, int height) {
        try {
            ...
            FFmpegFrameRecorder recorder = new FFmpegFrameRecorder("./movie/reflectionFun.mp4", width, height);
            ...
            if (screenshots != null) {
                List<String> fileNames = Arrays.stream(screenshots)
                        ...
                        .filter(name-> name.contains("MovingCameraScene"))
                        .sorted()
    ...
    public static void main(String[] args){
        new MovieConverter().convertFramesToMovie(1280, 720);
    }
}
